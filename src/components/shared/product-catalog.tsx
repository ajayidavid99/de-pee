...
export default function ProductCatalog({ initialProducts, initialCategories }: ProductCatalogProps) {
  ...
  return (
    <div className="w-full min-h-screen bg-background text-foreground pt-[var(--app-header-height)] pb-16">
      <div className="mx-auto max-w-7xl px-4 lg:px-6 py-6">
        
        {/* Search & Mobile Toggle Layout Header */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 items-start">
          ...
          {/* Interactive Products Display Cards Core View */}
                  ...
                  <Card key={product.id} className="flex flex-col justify-between overflow-hidden border-border/60 hover:shadow-sm transition-shadow">
                    ...
                    <div className="p-3 pt-0 space-y-2 border-t border-border/30 mt-2 bg-muted/10">
                      <div className="flex items-center justify-between gap-2">
                        ...
                        <Button onClick={() => addToQuote(product)} size="sm" className="h-7 text-[10px] px-2.5 bg-blue-600 hover:bg-blue-700 text-white font-bold">
                          Add to Request
                        </Button>
                      </div>
          ...
          <div className="space-y-4">
            <Card className="p-4 border-border/80 shadow-xs">
              ...
              {formSubmitted ? (
                ...
                <div className="text-center py-10 text-muted-foreground border border-dashed border-border rounded-lg space-y-1.5">
