                  ...
                  <div className="relative w-full h-32 sm:h-36 isolate">
                    ...
                    <div className="absolute inset-0 z-10 flex flex-col justify-between p-3.5 sm:p-4">
                      ...
                      <div className="flex items-start gap-2">
                        <div className="h-4 w-1 rounded-full bg-primary/40 group-hover:bg-primary group-hover:h-full transition-all duration-300 shrink-0 mt-0.5" />
                        <h3 className="text-xs sm:text-sm font-bold text-white line-clamp-2 leading-snug drop-shadow-[0_2px_4px_rgba(0,0,0,0.9)]">
                          {category.name}
                        </h3>
                      </div>
